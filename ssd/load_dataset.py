...
train_dataset = DataGenerator(load_images_into_memory=False, hdf5_dataset_path='ssd_480cat_train.h5')
...
VOC_2007_images_dir = '../480cat/images/'
#
# # The directories that contain the annotations.
VOC_2007_annotations_dir = '../480cat/labels_xml/'

# # The paths to the image sets.
VOC_2007_train_image_set_filename = '../480cat/train.txt'
# VOC_2007_val_image_set_filename      = '../cat_dataset/ImageSets/val.txt'
VOC_2007_trainval_image_set_filename = '../480cat/val.txt'
# VOC_2007_test_image_set_filename     = '../cat_dataset/ImageSets/test.txt'
#
...
#
# train_dataset.create_hdf5_dataset(file_path='ssd_480cat_train.h5',
#                                   resize=False,
#                                   variable_image_size=True,
#                                   verbose=True)

# val_dataset.create_hdf5_dataset(file_path='ssd_120cat_val.h5',
#                                 resize=False,
#                                 variable_image_size=True,
#                                 verbose=True)
...
model_checkpoint = ModelCheckpoint(
    filepath='../epoch-saved/ssd300_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
    monitor='val_loss',
    verbose=1,
    save_best_only=True,
...
csv_logger = CSVLogger(filename='../epoch-saved/ssd300_training_log.csv',
                       separator=',',
                       append=True)
